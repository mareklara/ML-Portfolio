...
//       <h2 className="text-4xl sm:text-6xl text-cyan mb-10">About Me</h2>
  ...
  return (
    <div className="flex flex-col items-center md:items-start text-center md:text-left">
      ...
      <Link
        ...
        className="cursor-pointer"
      >
        <button className="border border-orange rounded-full py-2 px-4 text-lg flex items-center mt-10 hover:bg-orange transition-all duration-500 cursor-pointer text-white hover:text-cyan">
          My Projects
        </button>
      </Link>
    </div>
